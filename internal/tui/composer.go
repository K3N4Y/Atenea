...
func (c composer) handleKey(msg tea.KeyMsg, commands []command.Command, listFiles func() ([]string, error), models modelSource) (composer, composerIntent, tea.Cmd) {
	...
	if msg.Type == tea.KeyEnter && !c.menuOpen() &&
		(c.input.Value() == "/new" || c.input.Value() == "/compact" || c.input.Value() == "/checkpoint" || c.input.Value() == "/rewind" || c.input.Value() == "/resume" || c.input.Value() == "/skills") {
	...
	if c.menuOpen() {
		...
		case tea.KeyEnter:
			...
			if selected.builtin && (selected.label == "/new" || selected.label == "/compact" || selected.label == "/checkpoint" || selected.label == "/rewind" || selected.label == "/resume" || selected.label == "/skills" || selected.label == "/model" || selected.label == "/mcp" || selected.label == "/connect" || selected.label == "/mode" || selected.label == "/mode:auto-accept" || selected.label == "/mode:ask" || selected.label == "/mode:yolo" || isDevelopmentBuiltinSelection(selected.label)) {
